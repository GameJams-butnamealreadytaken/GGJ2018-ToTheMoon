...
protected:
	...
	static bool			OnButtonPlayClicked		(ShGUIControlButton * pButton);
	static bool			OnButtonSettingsClicked	(ShGUIControlButton * pButton);
	static bool			OnButtonExitClicked		(ShGUIControlButton * pButton);
